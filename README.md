...
|---|---|---|---|---|---|
| [qwen3-27b-nvfp4-vllm-dflash2-dual-5090](recipes/qwen3-27b-nvfp4-vllm-dflash2-dual-5090/) **(prod)** | Qwen3.8-27B-NVFP4 (Inferact) | vLLM nightly + DFlash2 | 133-139 tok/s | 266 tok/s | 262k (native) |
...
The two DFlash2 recipes serve one drafter release (2026-08-18) on engines that
both need patching to run it. Speed only: the drafted rows are decode
throughput, and only the prod recipe carries an accuracy run.
