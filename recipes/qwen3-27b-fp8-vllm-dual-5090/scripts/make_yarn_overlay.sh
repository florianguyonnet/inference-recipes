...
#
# The overlay lives INSIDE the cache (${HF_HOME}/overlay-fp8-yarn512k) and uses
...
REPO_ID="${1:-${HF_REPO_ID:-Qwen/Qwen3.8-27B-FP8}}"
OVERLAY_DIR="${HF_HOME}/overlay-fp8-yarn512k"
PATCHED_CONFIG="${PROJECT_DIR}/models/Qwen3.8-27B-FP8-yarn512k/config.json"
