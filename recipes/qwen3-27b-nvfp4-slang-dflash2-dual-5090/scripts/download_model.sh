...
# Pre-download target + drafter through the container (optional: start.sh
...
if [[ $# -gt 0 ]]; then
    ...
    MODELS=("${HF_REPO_ID:-Inferact/Qwen3.8-27B-NVFP4}" "${DFLASH_DRAFT_ID:-incoai/Qwen3.8-27B-DFlash2}")
fi
